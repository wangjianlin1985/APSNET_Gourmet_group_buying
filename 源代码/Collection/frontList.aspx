<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frontList.aspx.cs" Inherits="Collection_frontList" %>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>收藏id</td><td>被收藏商品</td><td>收藏用户</td><td>收藏时间</td><td>操作</td></tr>
				    					<asp:Repeater ID="RpCollection" runat="server">
 										...
 										<tr>
 											...
 											<td>
 												...
 												<a href="#" onclick="collectionDelete('<%#Eval("collectionId")%>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										</ItemTemplate>
 										</asp:Repeater>
