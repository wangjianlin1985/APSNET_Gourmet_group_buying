...
using System.Data;
public partial class Collection_frontList : System.Web.UI.Page
{
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("userFrontList.aspx?productObj=" + productObj.SelectedValue.Trim() + "&&userObj=" + userObj.SelectedValue.Trim()+ "&&collectionTime=" + collectionTime.Text.Trim());
        }
