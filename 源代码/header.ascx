...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">美食团购网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>ProductComment/frontlist.aspx">商品评论</a></li>
                <li><a href="<%=basePath %>OrderInfo/frontlist.aspx">订单</a></li> -->
                <li><a href="<%=basePath %>Seller/frontlist.aspx">商家查询</a></li>
                <li><a href="<%=basePath %>Area/frontlist.aspx">区域查询</a></li>
                <li><a href="<%=basePath %>ProductClass/frontlist.aspx">商品类别</a></li>
                <li><a href="<%=basePath %>Product/frontlist.aspx">商品查询</a></li>
                <li><a href="<%=basePath %>Collection/frontlist.aspx">商品收藏</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>UserInfo/frontAdd.aspx"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;用户注册</a></li>
                <li><a href="<%=basePath %>Seller/frontAdd.aspx"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;商家注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>OrderInfo/userFrontlist.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的订单查询</a></li>
                        <li><a href="<%=basePath %>ProductComment/userFrontlist.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的评论</a></li>
                        <li><a href="<%=basePath %>Collection/userFrontlist.aspx"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我收藏的宝贝</a></li>
