...
public partial class UserInfo_UserInfoController : System.Web.UI.Page
{
    ...
    protected void addUserInfo()
    {
        ...
        userInfo.areaObj = int.Parse(Request["userInfo.areaObj.areaId"]);
    ...
    protected void getUserInfo()
    {
        ...
        jsonUserInfo.Put("areaObj", BLL.bllArea.getSomeArea(userInfo.areaObj).areaName);
        jsonUserInfo.Put("areaObjPri", userInfo.areaObj);
