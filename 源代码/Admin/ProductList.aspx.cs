    ...
    public partial class ProductList : System.Web.UI.Page
    {
        ...
        private void BindsellerObj()
        {
            ...
            for (int i = 0; i < sellerObjDs.Tables[0].Rows.Count; i++)
            {
                ...
                li = new ListItem(dr["sellerName"].ToString(), dr["sellerName"].ToString());
                sellerObj.Items.Add(li);
            }
        ...
        {
            Response.Redirect("ProductList.aspx?productClassObj=" + productClassObj.SelectedValue.Trim()+ "&&productName=" + productName.Text.Trim() + "&&sellerObj=" + sellerObj.SelectedValue.Trim() + "&&areaObj=" + areaObj.SelectedValue.Trim()+ "&&addTime=" + addTime.Text.Trim());
        }
