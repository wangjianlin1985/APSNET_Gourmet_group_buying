...
namespace chengxusheji.Admin
{
    public partial class CollectionList : System.Web.UI.Page
    {
        ...
        protected void BtnAllDel_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
            {
                try
                {
                    ...
                    {
                        Common.ShowMessage.Show(Page, "suess", "信息成功删除..", "CollectionList.aspx");
                    }
                    else
                    {
        ...
        protected void RpCollection_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "Del")
            {
                try
                {
                    ...
                    {
                        Common.ShowMessage.Show(Page, "seuss", "信息删除成功...", "CollectionList.aspx");
                    }
                    else
                    {
                        Common.ShowMessage.Show(Page, "seuss", "信息删除失败，请重试或联系管理人员...", "CollectionList.aspx");
                    }
                }
                catch
                {
                    Common.ShowMessage.Show(Page, "seuss", "删除失败...", "CollectionList.aspx");
                }
            }
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            sb.Append("<thead><tr><th colSpan='4'>商品收藏记录</th></tr>");
            sb.Append("<tr class='title'>");
            sb.Append("<th>收藏id</th>");
            sb.Append("<th>被收藏商品</th>");
            sb.Append("<th>收藏用户</th>");
            sb.Append("<th>收藏时间</th>");
            sb.Append("</tr></thead>");
            sb.Append("<tbody>");
