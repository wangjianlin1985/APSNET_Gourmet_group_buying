...
<body>
   <form id="form1" runat="server">
    <div class="div_All">
    <div class="Body_Title">商品收藏管理 》》商品收藏列表</div>
     <div class="Body_Search">
        被收藏商品&nbsp;&nbsp;<asp:DropDownList ID="productObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
        收藏用户&nbsp;&nbsp;<asp:DropDownList ID="userObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
        收藏时间&nbsp;&nbsp; <asp:TextBox ID="collectionTime"  runat="server" Width="112px" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>&nbsp;&nbsp;
    ...
    <asp:Repeater ID="RpCollection" runat="server" onitemcommand="RpCollection_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="CollectionEdit.aspx?collectionId=<%#Eval("collectionId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("collectionId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
